			...
			switch (LOWORD(wParam))
			{
				case FONT_BUTTON:
				{
					if (OpenFontDialog(hwnd, config.subtitlesFont, subtitlesHFont))
					{
						...
						SetFontAttributesText(hwnd, config.subtitlesFont);
					}
				}
				break;
...
void CreateSettingsWindow(HWND parent, HINSTANCE hInstance)
{
	...
	configWindowClass.lpfnWndProc = SettingsWindowProc;
	...
	HWND fontSettingsGroup = CreateWindowEx(0, L"BUTTON", (L"Font settings"), WS_VISIBLE | WS_CHILD | 0x00000007, 20, 11, 410, 163, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontSettingsGroup, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND fontLabel = CreateWindowEx(0, L"STATIC", (L"Font :"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_RIGHT, 33, 36, 75, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	fontValueLabel = CreateWindowEx(0, L"STATIC", (L"undefined"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_LEFT, 115, 36, 243, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontValueLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND fontSizeLabel = CreateWindowEx(0, L"STATIC", (L"Font height :"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_RIGHT, 33, 56, 75, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontSizeLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	fontSizeValueLabel = CreateWindowEx(0, L"STATIC", (L"undefined"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_LEFT, 115, 56, 243, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontSizeValueLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND fontStyleLabel = CreateWindowEx(0, L"STATIC", (L"Font style :"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_RIGHT, 33, 76, 75, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontStyleLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	fontStyleValueLabel = CreateWindowEx(0, L"STATIC", (L"undefined"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_LEFT, 115, 76, 243, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(fontStyleValueLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND alignmentLabel = CreateWindowEx(0, L"STATIC", (L"Alignment :"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_RIGHT, 33, 96, 75, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(alignmentLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND alignmentComboBox = CreateWindowEx(0, L"COMBOBOX", (L""), WS_VISIBLE | WS_CHILD | CBS_DROPDOWN | CBS_HASSTRINGS, 115, 93, 113, 49, settingsHWND, (HMENU)0, hInstance, 0);
	...
	HWND colorLabel = CreateWindowEx(0, L"STATIC", (L"Color :"), WS_VISIBLE | WS_CHILD | WS_GROUP | SS_RIGHT, 33, 120, 75, 16, settingsHWND, (HMENU)0, hInstance, 0);
	SendMessage(colorLabel, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND fontButton = CreateWindowEx(0, L"BUTTON", (L"Select Font"), WS_VISIBLE | WS_CHILD | WS_TABSTOP, 138, 146, 83, 23, settingsHWND, (HMENU)FONT_BUTTON, hInstance, 0);
	SendMessage(fontButton, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND colorButton = CreateWindowEx(0, L"BUTTON", (L"Select Color"), WS_VISIBLE | WS_CHILD | WS_TABSTOP, 236, 146, 83, 23, settingsHWND, (HMENU)COLOR_BUTTON, hInstance, 0);
	SendMessage(colorButton, WM_SETFONT, (WPARAM)hFont, FALSE);
	HWND applyButton = CreateWindowEx(0, L"BUTTON", (L"Apply"), WS_VISIBLE | WS_CHILD | WS_TABSTOP, 191, 187, 68, 23, settingsHWND, (HMENU)APPLY_BUTTON, hInstance, 0);
	SendMessage(applyButton, WM_SETFONT, (WPARAM)hFont, FALSE);
	SetFontAttributesText(settingsHWND, config.subtitlesFont);
}
			...
			switch (LOWORD(wParam))
			{
				case GAME_BUTTON:
				{
					if (OpenFileExplorer(hwnd, config.gamePath, MAX_PATH, LOWORD(wParam)))
						SetWindowText(game_text, PathFindFileName(config.gamePath));
				}
				break;
				...
				case SUBTITLES_BUTTON:
				{
					if (OpenFileExplorer(hwnd, config.subtitlesPath, MAX_PATH, LOWORD(wParam)))
						SetWindowText(subtitles_text, PathFindFileName(config.subtitlesPath));
				}
				break;

				case START_BUTTON: // When both game and file was selected
				{
					if (config.gamePath[0] != NULL && config.subtitlesPath[0] != NULL)
					{
						STARTUPINFO si;
...
int CreateMainWindow(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	AppendMenu(hMenu_1, MF_STRING, MENU_LOAD, (L"Load profile"));
	AppendMenu(hMenu_1, MF_STRING, MENU_SAVE, (L"Save profile"));
	...
	//Config window
	CreateSettingsWindow(mainHWND, hInstance);
