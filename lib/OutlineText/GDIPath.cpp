	...
	int cCount )
{
	...
	for (nIndex = 0; nIndex < cCount; nIndex++)
	{
		...
		case PT_LINETO | PT_CLOSEFIGURE:
			pPath->AddLine( static_cast<Gdiplus::REAL>(pptPrev->x), static_cast<Gdiplus::REAL>(pptPrev->y), static_cast<Gdiplus::REAL>(lppt[nIndex].x), static_cast<Gdiplus::REAL>(lppt[nIndex].y));
			pptPrev = &lppt[nIndex];
		...
		case PT_BEZIERTO | PT_CLOSEFIGURE:
			...
			pPath->AddBezier( 
				static_cast<Gdiplus::REAL>(pptPrev->x), static_cast<Gdiplus::REAL>(pptPrev->y),
				static_cast<Gdiplus::REAL>(lppt[nIndex].x), static_cast<Gdiplus::REAL>(lppt[nIndex].y),
				static_cast<Gdiplus::REAL>(lppt[nIndex+1].x), static_cast<Gdiplus::REAL>(lppt[nIndex+1].y),
				static_cast<Gdiplus::REAL>(lppt[nIndex+2].x), static_cast<Gdiplus::REAL>(lppt[nIndex+2].y) );
			nIndex += 2;
			pptPrev = &lppt[nIndex];
			if (pptLastMoveTo != NULL)
			{
	...
	{
		pPath->AddLine( static_cast<Gdiplus::REAL>(pptPrev->x), static_cast<Gdiplus::REAL>(pptPrev->y), static_cast<Gdiplus::REAL>(pptLastMoveTo->x), static_cast<Gdiplus::REAL>(pptLastMoveTo->y));
		//pPath->CloseFigure();
	}
}
